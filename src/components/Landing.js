...
//         zIndex: 1
//       }}>
//         <h2 style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 2 }}>
//           Why Slugtrition?
//         </h2>
//       </div>

//       {/* Scrollable Content */}
//       <div style={{ position: 'relative', zIndex: 3, paddingTop: '50vh', paddingBottom: '50vh' }}> {/* Reduced padding here */}
//         {/* Yellow cards */}
//         <div style={{ background: 'yellow', padding: '20px', borderRadius: '8px', margin: '20px auto', width: '80%' }}>
//           Card Content 1
//         </div>
//         <div style={{ background: 'yellow', padding: '20px', borderRadius: '8px', margin: '20px auto', width: '80%' }}>
//           Card Content 2
...
const PreFooter = () => {
  return (
    <div style={{ backgroundColor: 'var(--slug-yellow)', padding: '20px', textAlign: 'center', zIndex: 3}}>
      {/* Pre-Footer content */}
  ...
  return (
    <>
      <div className="landing d-flex flex-column">
        <Header />
        <HeroSection />
        {/* Other sections that fit within the main layout */}
